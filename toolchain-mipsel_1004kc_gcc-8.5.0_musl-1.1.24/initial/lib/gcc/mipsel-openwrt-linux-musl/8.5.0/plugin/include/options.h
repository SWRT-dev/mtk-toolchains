...
enum opt_code
{
  ...
  OPT_fhonour_copts = 724,                   /* -fhonour-copts */
  OPT_fhosted = 725,                         /* -fhosted */
  /* OPT_fhuge_objects = 726, */             /* -fhuge-objects */
  OPT_fident = 727,                          /* -fident */
  OPT_fif_conversion = 728,                  /* -fif-conversion */
  OPT_fif_conversion2 = 729,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 730,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 731,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 732,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 733,             /* -fimplicit-templates */
  OPT_findirect_inlining = 734,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 735,         /* -finhibit-size-directive */
  OPT_finit_character_ = 736,                /* -finit-character= */
  OPT_finit_derived = 737,                   /* -finit-derived */
  ...
  OPT_fipa_bit_cp = 757,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 758,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 759, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 760,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 761,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 762,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 763,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 764, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 765,                    /* -fipa-profile */
  OPT_fipa_pta = 766,                        /* -fipa-pta */
  OPT_fipa_pure_const = 767,                 /* -fipa-pure-const */
  OPT_fipa_ra = 768,                         /* -fipa-ra */
  OPT_fipa_reference = 769,                  /* -fipa-reference */
  OPT_fipa_sra = 770,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 771, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 772,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 773,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 774,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 775,              /* -fira-loop-pressure */
  OPT_fira_region_ = 776,                    /* -fira-region= */
  OPT_fira_share_save_slots = 777,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 778,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 779,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 780,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 781,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 782,               /* -fivar-visibility= */
  OPT_fivopts = 783,                         /* -fivopts */
  OPT_fjump_tables = 784,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 785,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 786,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 787,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 788,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 789,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 790, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 791,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 792,             /* -fleading-underscore */
  OPT_flifetime_dse = 793,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 794,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 795,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 796,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 797,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 798,                    /* -flocal-ivars */
  /* OPT_floop_block = 799, */               /* -floop-block */
  /* OPT_floop_flatten = 800, */             /* -floop-flatten */
  OPT_floop_interchange = 801,               /* -floop-interchange */
  OPT_floop_nest_optimize = 802,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 803, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 804,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 805, */          /* -floop-strip-mine */
  OPT_floop_unroll_and_jam = 806,            /* -floop-unroll-and-jam */
  OPT_flra_remat = 807,                      /* -flra-remat */
  OPT_flto = 808,                            /* -flto */
  OPT_flto_compression_level_ = 809,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 810,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 811,                 /* -flto-partition= */
  OPT_flto_report = 812,                     /* -flto-report */
  OPT_flto_report_wpa = 813,                 /* -flto-report-wpa */
  OPT_flto_ = 814,                           /* -flto= */
  OPT_fltrans = 815,                         /* -fltrans */
  OPT_fltrans_output_list_ = 816,            /* -fltrans-output-list= */
  OPT_fmacro_prefix_map_ = 817,              /* -fmacro-prefix-map= */
  OPT_fmath_errno = 818,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 819,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 820,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 821,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 822,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 823,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 824,                     /* -fmem-report */
  OPT_fmem_report_wpa = 825,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 826,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 827,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 828,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 829,                /* -fmessage-length= */
  OPT_fmodule_private = 830,                 /* -fmodule-private */
  OPT_fmodulo_sched = 831,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 832,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 833,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 834,                  /* -fms-extensions */
  /* OPT_fmudflap = 835, */                  /* -fmudflap */
  /* OPT_fmudflapir = 836, */                /* -fmudflapir */
  /* OPT_fmudflapth = 837, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 838, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 839, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 840,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 841,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 842,                   /* -fnext-runtime */
  OPT_fnil_receivers = 843,                  /* -fnil-receivers */
  ...
  OPT_foptimize_strlen = 868,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 869, */           /* -foptional-diags */
  OPT_fpack_derived = 870,                   /* -fpack-derived */
  OPT_fpack_struct = 871,                    /* -fpack-struct */
  OPT_fpack_struct_ = 872,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 873,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 874,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 875,              /* -fpcc-struct-return */
  OPT_fpch_deps = 876,                       /* -fpch-deps */
  OPT_fpch_preprocess = 877,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 878,                     /* -fpeel-loops */
  OPT_fpeephole = 879,                       /* -fpeephole */
  OPT_fpeephole2 = 880,                      /* -fpeephole2 */
  OPT_fpermissive = 881,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 882,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 883,                            /* -fpic */
  OPT_fpie = 884,                            /* -fpie */
  ...
  OPT_fprintf_return_value = 895,            /* -fprintf-return-value */
  OPT_fprofile = 896,                        /* -fprofile */
  OPT_fprofile_abs_path = 897,               /* -fprofile-abs-path */
  ...
  OPT_fprofile_update_ = 905,                /* -fprofile-update= */
  ...
  OPT_frtti = 943,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 944,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_ = 945,             /* -fsanitize-coverage= */
  ...
  OPT_fself_test_ = 980,                     /* -fself-test= */
  ...
  OPT_fshrink_wrap_separate = 986,           /* -fshrink-wrap-separate */
  ...
  OPT_fsplit_loops = 996,                    /* -fsplit-loops */
  ...
  OPT_fstack_clash_protection = 1007,        /* -fstack-clash-protection */
  ...
  OPT_fstore_merging = 1019,                 /* -fstore-merging */
  ...
  /* OPT_fstrong_eval_order = 1026, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1027,            /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 1028,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1029,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1030,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1031, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1032,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1033, */             /* -ftarget-help */
  ...
  OPT_ftest_forall_temp = 1038,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1039, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1040,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1041,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1042,                   /* -ftime-report */
  OPT_ftime_report_details = 1043,           /* -ftime-report-details */
  OPT_ftls_model_ = 1044,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1045,              /* -ftoplevel-reorder */
  OPT_ftracer = 1046,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1047,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1048,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1049,                   /* -ftrampolines */
  ...
  OPT_fuse_cxa_atexit = 1108,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1109,     /* -fuse-cxa-get-exception-ptr */
  ...
  OPT_fwrapv_pointer = 1140,                 /* -fwrapv-pointer */
  /* OPT_fxref = 1141, */                    /* -fxref */
  /* OPT_fzee = 1142, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1143,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1144,                     /* -fzero-link */
  OPT_g = 1145,                              /* -g */
  OPT_gant = 1146,                           /* -gant */
  OPT_gas_loc_support = 1147,                /* -gas-loc-support */
  OPT_gas_locview_support = 1148,            /* -gas-locview-support */
  /* OPT_gcoff = 1149, */                    /* -gcoff */
  /* OPT_gcoff1 = 1150, */                   /* -gcoff1 */
  /* OPT_gcoff2 = 1151, */                   /* -gcoff2 */
  /* OPT_gcoff3 = 1152, */                   /* -gcoff3 */
  OPT_gcolumn_info = 1153,                   /* -gcolumn-info */
  OPT_gdwarf = 1154,                         /* -gdwarf */
  OPT_gdwarf_ = 1155,                        /* -gdwarf- */
  OPT_gen_decls = 1156,                      /* -gen-decls */
  OPT_ggdb = 1157,                           /* -ggdb */
  OPT_ggnu_pubnames = 1158,                  /* -ggnu-pubnames */
  OPT_ginline_points = 1159,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1160, /* -ginternal-reset-location-views */
  OPT_gnat = 1161,                           /* -gnat */
  OPT_gnatO = 1162,                          /* -gnatO */
  OPT_gno_ = 1163,                           /* -gno- */
  OPT_gno_pubnames = 1164,                   /* -gno-pubnames */
  OPT_gpubnames = 1165,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1166,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1167,                   /* -gsplit-dwarf */
  OPT_gstabs = 1168,                         /* -gstabs */
  OPT_gstabs_ = 1169,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1170,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1171,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1172,                        /* -gtoggle */
  OPT_gvariable_location_views = 1173,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1174,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1175,                           /* -gvms */
  OPT_gxcoff = 1176,                         /* -gxcoff */
  OPT_gxcoff_ = 1177,                        /* -gxcoff+ */
  OPT_gz = 1178,                             /* -gz */
  OPT_gz_ = 1179,                            /* -gz= */
  OPT_h = 1180,                              /* -h */
  OPT_idirafter = 1181,                      /* -idirafter */
  OPT_imacros = 1182,                        /* -imacros */
  OPT_imultiarch = 1183,                     /* -imultiarch */
  OPT_imultilib = 1184,                      /* -imultilib */
  OPT_include = 1185,                        /* -include */
  OPT_iplugindir_ = 1186,                    /* -iplugindir= */
  OPT_iprefix = 1187,                        /* -iprefix */
  OPT_iquote = 1188,                         /* -iquote */
  OPT_isysroot = 1189,                       /* -isysroot */
  OPT_isystem = 1190,                        /* -isystem */
  OPT_iwithprefix = 1191,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1192,              /* -iwithprefixbefore */
  OPT_k8 = 1193,                             /* -k8 */
  OPT_l = 1194,                              /* -l */
  OPT_lang_asm = 1195,                       /* -lang-asm */
  OPT_mabi_ = 1196,                          /* -mabi= */
  OPT_mabicalls = 1197,                      /* -mabicalls */
  OPT_mabs_ = 1198,                          /* -mabs= */
  OPT_mandroid = 1199,                       /* -mandroid */
  OPT_march_ = 1200,                         /* -march= */
  OPT_mbionic = 1201,                        /* -mbionic */
  OPT_mbranch_cost_ = 1202,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1203,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1204,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1205,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1206,             /* -mcompact-branches= */
  OPT_mdebug = 1207,                         /* -mdebug */
  OPT_mdebugd = 1208,                        /* -mdebugd */
  OPT_mdivide_breaks = 1209,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1210,                  /* -mdivide-traps */
  OPT_mdmx = 1211,                           /* -mdmx */
  OPT_mdouble_float = 1212,                  /* -mdouble-float */
  OPT_mdsp = 1213,                           /* -mdsp */
  OPT_mdspr2 = 1214,                         /* -mdspr2 */
  OPT_meb = 1215,                            /* -meb */
  OPT_mel = 1216,                            /* -mel */
  OPT_membedded_data = 1217,                 /* -membedded-data */
  OPT_meva = 1218,                           /* -meva */
  OPT_mexplicit_relocs = 1219,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1220,                  /* -mextern-sdata */
  OPT_mfix_24k = 1221,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1222,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1223,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1224,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1225,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1226,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1227,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1228,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1229,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1230,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1231,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1232,                 /* -mfp-exceptions */
  OPT_mfp32 = 1233,                          /* -mfp32 */
  OPT_mfp64 = 1234,                          /* -mfp64 */
  OPT_mfpxx = 1235,                          /* -mfpxx */
  OPT_mframe_header_opt = 1236,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 1237, */              /* -mfused-madd */
  OPT_mglibc = 1238,                         /* -mglibc */
  OPT_mgp32 = 1239,                          /* -mgp32 */
  OPT_mgp64 = 1240,                          /* -mgp64 */
  OPT_mgpopt = 1241,                         /* -mgpopt */
  OPT_mhard_float = 1242,                    /* -mhard-float */
  OPT_mimadd = 1243,                         /* -mimadd */
  OPT_minterlink_compressed = 1244,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1245,              /* -minterlink-mips16 */
  OPT_mips = 1246,                           /* -mips */
  OPT_mips16 = 1247,                         /* -mips16 */
  OPT_mips3d = 1248,                         /* -mips3d */
  OPT_mllsc = 1249,                          /* -mllsc */
  OPT_mload_store_pairs = 1250,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 1251,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1252,                    /* -mlong-calls */
  OPT_mlong32 = 1253,                        /* -mlong32 */
  OPT_mlong64 = 1254,                        /* -mlong64 */
  OPT_mlra = 1255,                           /* -mlra */
  OPT_mlxc1_sxc1 = 1256,                     /* -mlxc1-sxc1 */
  OPT_mmad = 1257,                           /* -mmad */
  OPT_mmadd4 = 1258,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 1259,             /* -mmcount-ra-address */
  OPT_mmcu = 1260,                           /* -mmcu */
  OPT_mmemcpy = 1261,                        /* -mmemcpy */
  OPT_mmicromips = 1262,                     /* -mmicromips */
  OPT_mmsa = 1263,                           /* -mmsa */
  OPT_mmt = 1264,                            /* -mmt */
  OPT_mmusl = 1265,                          /* -mmusl */
  OPT_mnan_ = 1266,                          /* -mnan= */
  OPT_mno_float = 1267,                      /* -mno-float */
  OPT_mno_flush_func = 1268,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1269,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1270,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1271,                     /* -mno-mips3d */
  OPT_modd_spreg = 1272,                     /* -modd-spreg */
  OPT_mpaired_single = 1273,                 /* -mpaired-single */
  OPT_mplt = 1274,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1275,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1276,               /* -mrelax-pic-calls */
  OPT_mshared = 1277,                        /* -mshared */
  OPT_msingle_float = 1278,                  /* -msingle-float */
  OPT_msmartmips = 1279,                     /* -msmartmips */
  OPT_msoft_float = 1280,                    /* -msoft-float */
  OPT_msplit_addresses = 1281,               /* -msplit-addresses */
  OPT_msym32 = 1282,                         /* -msym32 */
  OPT_msynci = 1283,                         /* -msynci */
  OPT_mtune_ = 1284,                         /* -mtune= */
  OPT_muclibc = 1285,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1286,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1287,                          /* -mvirt */
  OPT_mvr4130_align = 1288,                  /* -mvr4130-align */
  OPT_mxgot = 1289,                          /* -mxgot */
  OPT_mxpa = 1290,                           /* -mxpa */
  OPT_n = 1291,                              /* -n */
  OPT_no_canonical_prefixes = 1292,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1293,              /* -no-integrated-cpp */
  OPT_no_pie = 1294,                         /* -no-pie */
  OPT_noasmopt = 1295,                       /* -noasmopt */
  OPT_nocpp = 1296,                          /* -nocpp */
  OPT_nodefaultlibs = 1297,                  /* -nodefaultlibs */
  ...
  OPT_pie = 1308,                            /* -pie */
  OPT_pipe = 1309,                           /* -pipe */
  OPT_posix = 1310,                          /* -posix */
  OPT_print_file_name_ = 1311,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1312,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1313,          /* -print-multi-directory */
  OPT_print_multi_lib = 1314,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1315,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1316,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1317,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1318,               /* -print-prog-name= */
  OPT_print_search_dirs = 1319,              /* -print-search-dirs */
  OPT_print_sysroot = 1320,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1321,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1322,                        /* -profile */
  OPT_pthread = 1323,                        /* -pthread */
  OPT_quiet = 1324,                          /* -quiet */
  OPT_r = 1325,                              /* -r */
  OPT_rdynamic = 1326,                       /* -rdynamic */
  OPT_remap = 1327,                          /* -remap */
  OPT_s = 1328,                              /* -s */
  OPT_save_temps = 1329,                     /* -save-temps */
  OPT_save_temps_ = 1330,                    /* -save-temps= */
  OPT_shared = 1331,                         /* -shared */
  OPT_shared_libgcc = 1332,                  /* -shared-libgcc */
  /* OPT_specs = 1333, */                    /* -specs */
  OPT_specs_ = 1334,                         /* -specs= */
  OPT_static = 1335,                         /* -static */
  OPT_static_libasan = 1336,                 /* -static-libasan */
  OPT_static_libgcc = 1337,                  /* -static-libgcc */
  OPT_static_libgfortran = 1338,             /* -static-libgfortran */
  OPT_static_libgo = 1339,                   /* -static-libgo */
  OPT_static_liblsan = 1340,                 /* -static-liblsan */
  OPT_static_libmpx = 1341,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1342,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1343,               /* -static-libstdc++ */
  OPT_static_libtsan = 1344,                 /* -static-libtsan */
  OPT_static_libubsan = 1345,                /* -static-libubsan */
  OPT_static_pie = 1346,                     /* -static-pie */
  /* OPT_std_c__03 = 1347, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1348, */                /* -std=c++0x */
  OPT_std_c__11 = 1349,                      /* -std=c++11 */
  OPT_std_c__14 = 1350,                      /* -std=c++14 */
  OPT_std_c__17 = 1351,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1352, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1353, */                /* -std=c++1z */
  OPT_std_c__2a = 1354,                      /* -std=c++2a */
  OPT_std_c__98 = 1355,                      /* -std=c++98 */
  OPT_std_c11 = 1356,                        /* -std=c11 */
  OPT_std_c17 = 1357,                        /* -std=c17 */
  /* OPT_std_c18 = 1358, */                  /* -std=c18 */
  /* OPT_std_c1x = 1359, */                  /* -std=c1x */
  /* OPT_std_c89 = 1360, */                  /* -std=c89 */
  OPT_std_c90 = 1361,                        /* -std=c90 */
  OPT_std_c99 = 1362,                        /* -std=c99 */
  /* OPT_std_c9x = 1363, */                  /* -std=c9x */
  OPT_std_f2003 = 1364,                      /* -std=f2003 */
  OPT_std_f2008 = 1365,                      /* -std=f2008 */
  OPT_std_f2008ts = 1366,                    /* -std=f2008ts */
  OPT_std_f2018 = 1367,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1377,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1378,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1379,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1380,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1381, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1382, */                /* -std=gnu1x */
