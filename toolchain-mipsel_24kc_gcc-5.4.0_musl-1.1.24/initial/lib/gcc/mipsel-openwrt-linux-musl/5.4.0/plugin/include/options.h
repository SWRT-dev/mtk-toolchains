...
enum opt_code
{
  ...
  OPT_Werror_maybe_reset = 233,              /* -Werror-maybe-reset */
  ...
  OPT_fhonour_copts = 701,                   /* -fhonour-copts */
  ...
  OPT_finhibit_size_directive = 714,         /* -finhibit-size-directive */
  OPT_finit_character_ = 715,                /* -finit-character= */
  OPT_finit_integer_ = 716,                  /* -finit-integer= */
  OPT_finit_local_zero = 717,                /* -finit-local-zero */
  OPT_finit_logical_ = 718,                  /* -finit-logical= */
  OPT_finit_real_ = 719,                     /* -finit-real= */
  OPT_finline = 720,                         /* -finline */
  OPT_finline_atomics = 721,                 /* -finline-atomics */
  OPT_finline_functions = 722,               /* -finline-functions */
  OPT_finline_functions_called_once = 723,   /* -finline-functions-called-once */
  ...
  OPT_fira_algorithm_ = 748,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 749,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 750,              /* -fira-loop-pressure */
  OPT_fira_region_ = 751,                    /* -fira-region= */
  OPT_fira_share_save_slots = 752,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 753,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 754,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 755,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 756,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 757,               /* -fivar-visibility= */
  OPT_fivopts = 758,                         /* -fivopts */
  OPT_fjni = 759,                            /* -fjni */
  OPT_fjump_tables = 760,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 761,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 762,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 763,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 764, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 765,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 766,             /* -fleading-underscore */
  OPT_flifetime_dse = 767,                   /* -flifetime-dse */
  ...
  /* OPT_fno_vect_cost_model = 813, */       /* -fno-vect-cost-model */
  ...
  OPT_foptimize_static_class_initialization = 837,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 838,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 839, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 840,              /* -foutput-class-dir= */
  ...
  OPT_freduced_reflection = 891,             /* -freduced-reflection */
  OPT_free = 892,                            /* -free */
  ...
  OPT_frtti = 909,                           /* -frtti */
  OPT_fsanitize_recover = 910,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 911,              /* -fsanitize-recover= */
  OPT_fsanitize_undefined_trap_on_error = 912,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 913,                      /* -fsanitize= */
  OPT_fsaw_java_file = 914,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 915,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 916,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 917,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 918,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 919,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 920,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 921,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 922,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 923,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 924,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 925,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 926,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 927,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 928,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 929,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 930,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 931,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 932, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 933,                /* -fschedule-fusion */
  OPT_fschedule_insns = 934,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 935,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 936,              /* -fsecond-underscore */
  OPT_fsection_anchors = 937,                /* -fsection-anchors */
  /* OPT_fsee = 938, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 939,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 940,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 941, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 942,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 943,          /* -fselective-scheduling2 */
  OPT_fsemantic_interposition = 944,         /* -fsemantic-interposition */
  OPT_fshort_double = 945,                   /* -fshort-double */
  OPT_fshort_enums = 946,                    /* -fshort-enums */
  OPT_fshort_wchar = 947,                    /* -fshort-wchar */
  OPT_fshow_column = 948,                    /* -fshow-column */
  OPT_fshrink_wrap = 949,                    /* -fshrink-wrap */
  OPT_fsign_zero = 950,                      /* -fsign-zero */
  OPT_fsignaling_nans = 951,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 952,               /* -fsigned-bitfields */
  OPT_fsigned_char = 953,                    /* -fsigned-char */
  OPT_fsigned_zeros = 954,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 955,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 956,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 957,             /* -fsized-deallocation */
  OPT_fsource_filename_ = 958,               /* -fsource-filename= */
  OPT_fsource_ = 959,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 960,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 961,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 962,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 963, */                 /* -fsquangle */
  OPT_fssa_phiopt = 964,                     /* -fssa-phiopt */
  OPT_fstack_arrays = 965,                   /* -fstack-arrays */
  /* OPT_fstack_check = 966, */              /* -fstack-check */
  OPT_fstack_check_ = 967,                   /* -fstack-check= */
  OPT_fstack_limit = 968,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 969,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 970,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 971,                /* -fstack-protector */
  OPT_fstack_protector_all = 972,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 973,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 974,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 975,                   /* -fstack-reuse= */
  OPT_fstack_usage = 976,                    /* -fstack-usage */
  OPT_fstats = 977,                          /* -fstats */
  OPT_fstdarg_opt = 978,                     /* -fstdarg-opt */
  OPT_fstore_check = 979,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 980, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 981,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 982,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 983,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 984, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 985,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 986,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 987,                    /* -fsyntax-only */
  OPT_ftabstop_ = 988,                       /* -ftabstop= */
  /* OPT_ftarget_help = 989, */              /* -ftarget-help */
  OPT_ftarget_ = 990,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 991,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 992, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 993,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 994,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 995, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 996,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 997,             /* -fthreadsafe-statics */
  OPT_ftime_report = 998,                    /* -ftime-report */
  OPT_ftls_model_ = 999,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 1000,              /* -ftoplevel-reorder */
  OPT_ftracer = 1001,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1002,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1003,        /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 1004,                 /* -ftrapping-math */
  OPT_ftrapv = 1005,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1006,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1007,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1008,                      /* -ftree-ccp */
  OPT_ftree_ch = 1009,                       /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 1010,    /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1011,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1012,                /* -ftree-copy-prop */
  OPT_ftree_copyrename = 1013,               /* -ftree-copyrename */
  OPT_ftree_cselim = 1014,                   /* -ftree-cselim */
  OPT_ftree_dce = 1015,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1016,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1017,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1018,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1019,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1020, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1021,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1022,          /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 1023,   /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1024,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1025,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1026, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1027,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1028,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1029,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1030,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1031,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1032,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1033,                      /* -ftree-pre */
  OPT_ftree_pta = 1034,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1035,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1036, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1037,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1038,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1039,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1040,                     /* -ftree-slsr */
  OPT_ftree_sra = 1041,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1042, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1043, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1044,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1045,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1046,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1047, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1048,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1049, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1050,                      /* -ftree-vrp */
  OPT_funderscoring = 1051,                  /* -funderscoring */
  OPT_funit_at_a_time = 1052,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1053,              /* -funroll-all-loops */
  OPT_funroll_loops = 1054,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1055,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1056,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1057,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1058,                 /* -funsigned-char */
  OPT_funswitch_loops = 1059,                /* -funswitch-loops */
  OPT_funwind_tables = 1060,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1061,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1062,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1063,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1064,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1065,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1066,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1067,                   /* -fuse-ld=gold */
  ...
  OPT_iremap = 1135,                         /* -iremap */
  OPT_isysroot = 1136,                       /* -isysroot */
  OPT_isystem = 1137,                        /* -isystem */
  OPT_iwithprefix = 1138,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1139,              /* -iwithprefixbefore */
  OPT_k8 = 1140,                             /* -k8 */
  OPT_l = 1141,                              /* -l */
  OPT_lang_asm = 1142,                       /* -lang-asm */
  OPT_mabi_ = 1143,                          /* -mabi= */
  OPT_mabicalls = 1144,                      /* -mabicalls */
  OPT_mabs_ = 1145,                          /* -mabs= */
  OPT_mandroid = 1146,                       /* -mandroid */
  OPT_march_ = 1147,                         /* -march= */
  OPT_mbionic = 1148,                        /* -mbionic */
  OPT_mbranch_cost_ = 1149,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1150,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1151,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1152,                /* -mcode-readable= */
  OPT_mdebug = 1153,                         /* -mdebug */
  OPT_mdebugd = 1154,                        /* -mdebugd */
  OPT_mdivide_breaks = 1155,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1156,                  /* -mdivide-traps */
  OPT_mdmx = 1157,                           /* -mdmx */
  OPT_mdouble_float = 1158,                  /* -mdouble-float */
  OPT_mdsp = 1159,                           /* -mdsp */
  OPT_mdspr2 = 1160,                         /* -mdspr2 */
  OPT_meb = 1161,                            /* -meb */
  OPT_mel = 1162,                            /* -mel */
  OPT_membedded_data = 1163,                 /* -membedded-data */
  OPT_meva = 1164,                           /* -meva */
  OPT_mexplicit_relocs = 1165,               /* -mexplicit-relocs */
  OPT_mextern_sdata = 1166,                  /* -mextern-sdata */
  OPT_mfix_24k = 1167,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1168,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1169,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1170,                     /* -mfix-r4400 */
  OPT_mfix_rm7000 = 1171,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1172,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1173,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1174,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1175,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1176,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1177,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1178,                 /* -mfp-exceptions */
  OPT_mfp32 = 1179,                          /* -mfp32 */
  OPT_mfp64 = 1180,                          /* -mfp64 */
  OPT_mfpxx = 1181,                          /* -mfpxx */
  OPT_mfused_madd = 1182,                    /* -mfused-madd */
  OPT_mglibc = 1183,                         /* -mglibc */
  OPT_mgp32 = 1184,                          /* -mgp32 */
  OPT_mgp64 = 1185,                          /* -mgp64 */
  OPT_mgpopt = 1186,                         /* -mgpopt */
  OPT_mhard_float = 1187,                    /* -mhard-float */
  OPT_mimadd = 1188,                         /* -mimadd */
  OPT_minterlink_compressed = 1189,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 1190,              /* -minterlink-mips16 */
  OPT_mips = 1191,                           /* -mips */
  OPT_mips16 = 1192,                         /* -mips16 */
  OPT_mips3d = 1193,                         /* -mips3d */
  OPT_mllsc = 1194,                          /* -mllsc */
  OPT_mlocal_sdata = 1195,                   /* -mlocal-sdata */
  OPT_mlong_calls = 1196,                    /* -mlong-calls */
  OPT_mlong32 = 1197,                        /* -mlong32 */
  OPT_mlong64 = 1198,                        /* -mlong64 */
  OPT_mlra = 1199,                           /* -mlra */
  OPT_mmad = 1200,                           /* -mmad */
  OPT_mmcount_ra_address = 1201,             /* -mmcount-ra-address */
  OPT_mmcu = 1202,                           /* -mmcu */
  OPT_mmemcpy = 1203,                        /* -mmemcpy */
  OPT_mmicromips = 1204,                     /* -mmicromips */
  OPT_mmt = 1205,                            /* -mmt */
