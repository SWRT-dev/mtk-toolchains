/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/magic/MTK/OpenWRT_4200/mtk-openwrt-lede-4.2.0.0/build_dir/toolchain-arm_cortex-a7_gcc-5.4.0_musl-1.1.24_eabi/gcc-5.4.0/gcc/config/arm/arm.md'.  */
